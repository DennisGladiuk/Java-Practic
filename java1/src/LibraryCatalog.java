    ...
    public static void main(String[] args) {
        ...
        while (true) {
            if (showCommands) {
                ...
                System.out.println("Save - save all books");
                System.out.println("Load - load all books");
                ...
                System.out.println("Update book - Update the information of a book.");
            ...
            switch (command) {
                ...
                case "search books by author":
                    ...
                    break;
                case "save":
                    System.out.println("Enter the filename to save the catalog:");
                    String saveFilename = sc.nextLine();
                    lm.saveCatalog(saveFilename);
                    System.out.println();
                    break;
                case "load":
                    System.out.println("Enter the filename to load the catalog:");
                    String loadFilename = sc.nextLine();
                    lm.loadCatalog(loadFilename);
                    System.out.println();
                    break;
                case "update book":
